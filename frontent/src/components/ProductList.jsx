      ...
      <div>
        ...
        <div className="w-full flex flex-wrap justify-center gap-6 p-1">
          {filteredProducts.map((item) => (
            <div
              className={`${theme.curr_BG} ${theme.curr_TEXT} w-full sm:w-1/2 md:w-1/3 lg:w-1/6 xl:w-1/5 rounded-xl border border-gray-200 shadow-sm hover:shadow-lg transition-all duration-300 overflow-hidden`}
            >
